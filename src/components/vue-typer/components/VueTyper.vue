...
const ERASE_STYLE: Record<string, string> = {
  BACKSPACE: 'backspace',
  ...
  props: {
    ...
    initialAction: {
      ...
      validator: (value: string) =>
        !!value.match(`^${STATE.TYPING}|${STATE.ERASING}$`),
    },
    /**
  ...
  methods: {
    init() {
      ...
      if (typeof this.text === 'string') {
        ...
        let textCopy = this.text.slice() as string[];
